...
// ../.wrangler/tmp/bundle-tRuFUS/checked-fetch.js
...
// api/auth/me.ts
var onRequestGet = /* @__PURE__ */ __name(async ({ data }) => {
  if (!data.user) {
    return new Response(JSON.stringify({ error: "Unauthorized" }), {
      status: 401,
      headers: { "Content-Type": "application/json" }
...
// api/auth/update_password.ts
var onRequestPost3 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
...
// api/daily_brief/dates.ts
var onRequestGet2 = /* @__PURE__ */ __name(async ({ env, data }) => {
  try {
...
// api/daily_brief/preview.ts
var onRequestGet3 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    if (data.user?.role !== "admin") {
      return new Response(JSON.stringify({ error: "Unauthorized" }), { status: 401 });
    }
...
// api/action_completions/index.ts
var onRequestGet5 = /* @__PURE__ */ __name(async ({ env, data }) => {
  try {
...
var onRequestPost4 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    const sessionId = data.user.id;
    const body = await request.json();
...
// api/agent_run_history/index.ts
var onRequestGet6 = /* @__PURE__ */ __name(async ({ env, data }) => {
  try {
    if (data.user?.role !== "admin") {
...
// api/daily_diff/index.ts
var onRequestGet8 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    const url = new URL(request.url);
...
// api/delete_story/index.ts
var onRequestPost5 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    if (data.user?.role !== "admin") {
...
var onRequestPost6 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    const body = await request.json();
...
var onRequestDelete = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    const url = new URL(request.url);
    const type = url.searchParams.get("type");
...
var onRequestPost7 = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  if (data.user?.role !== "admin") {
...
// api/historical_context/index.ts
...
// api/user_settings/index.ts
var onRequestGet13 = /* @__PURE__ */ __name(async ({ env, data }) => {
  try {
    const sessionId = data.user.id;
    const { results } = await env.DB.prepare(
...
var onRequestPatch = /* @__PURE__ */ __name(async ({ request, env, data }) => {
  try {
    const sessionId = data.user.id;
    const body = await request.json();
    const { timezone } = body;
...
// ../.wrangler/tmp/pages-BabGJd/functionsRoutes-0.4846726598401556.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-tRuFUS/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-tRuFUS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.128181689925549.mjs.map
